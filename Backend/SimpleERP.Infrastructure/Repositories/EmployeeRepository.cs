...
public class EmployeeRepository : IEmployeeRepository
{
    ...
    public async Task<PagedResultDTO<EmployeeDTO>> GetPagedEmployeesAsync(int pageNumber, int pageSize, string? searchTerm, string? departmentId)
    {
        ...
        {
            query = query.Where(e => e.Department != null && e.Department.DepartmentName == departmentId);
        }
        ...
        if (!string.IsNullOrWhiteSpace(searchTerm))
        {
            ...
            query = query.Where(e => 
                ...
                (e.Department != null && e.Department.DepartmentName.ToLower().Contains(lowerSearch))
            );
        }
        // 2. Count Total
